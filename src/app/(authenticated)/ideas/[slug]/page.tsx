...
const Page = () => {
    ...
    const { data, isFetching, error, isLoading, isPlaceholderData } = useFetchIdeaDetails(slug.toString());
                ...
                <div className="w-full mx-auto px-6 mb-6">
                    ...
                    <div className="space-y-6">
                        <div className="flex space-x-3">
                            <Image className="aspect-circle w-9 h-9" alt="Sarrah" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkYbWQRmPgmQIMT7oEJFZuFWoGPMhH59WUkyToaSfXsg&s" width={9} height={9} />

                            <div>
                                <div className="text-sm font-medium">Anna</div>
                                <div className="text-xs text-gray-500">2 months ago</div>
                                <p className="mt-1 text-sm text-gray-700">
                                    I don't quite know about this though but it seems like that is really not good for all.
                                </p>
                                <div className="mt-2 flex items-center text-sm text-gray-500">
                                    <ThumbsUpIcon className="h-4 w-4" />
                                    <span className="ml-1">2k</span>
